...
export function PublicLanding() {
  ...
  const contractAddress = shortContract(process.env.NEXT_PUBLIC_FAULTSPAN_CONTRACT_ADDRESS);
      ...
      <main className="public-landing">
        ...
        <section className="public-hero">
          ...
          <aside className="public-proof-card" aria-label="Runtime proof">
            ...
            <div><span>Contract</span><strong className="mono">{contractAddress}</strong></div>
            <div><span>Evidence</span><strong>IPFS via Pinata</strong></div>
        ...
        <section className="public-grid" id="product-pillars" aria-label="Product pillars">
          ...
          <article><Database aria-hidden="true" /><h2>Searchable projection</h2><p>Index case metadata in Cloudflare D1 without inventing demo disputes.</p></article>
