...
function toSpanStatus(value?: string): SpanStatus {
  if (value === "PROPOSED" || value === "BONDED" || value === "DELIVERED") return value;
  return "PROPOSED";
}
